...
return [
    ...
    'rules_confirmation' => 'I have read the <a class="text-blue-600" href="'.config(
        'services.wiki.rules_link'
    ).'">project rules</a>, I fully agree with them and undertake to abide by them, and also unconditionally acknowledge the project administration\'s right to interpret them',
    'name' => 'Name',
    'gender' => 'Gender',
    'race' => 'Race',
    'age' => 'Age',
