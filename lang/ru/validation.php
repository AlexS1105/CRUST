...
return [
    ...
    'craftpool' => [
        'maxtiers' => 'Персонаж может иметь только два ремесла одной отрасли.',
        'magic' => 'Недостаточное количество очков навыка магии.',
        'tech' => 'Недостаточное количество очков навыка техники.',
        'general' => 'Недостаточное количество очков навыка магии / техники.',
        'narrative_crafts' => 'Недостаточно очков для взятия умений.'
    ],
    'narrative_crafts' => 'Недостаточно очков навыков.',
    'perkpool' => [
        'invalid' => 'Непредвиденная ошибка взятия перков. Выберите новые или обратитесь к администрации.',
        'too_much_combat' => 'Недостаточно слотов для боевых перков.',
        'too_much_noncombat' => 'Недостаточно слотов для небоевых перков.',
        'only_one_attack' => 'Можно иметь только один атакующий боевой перк.',
        'only_one_defence' => 'Можно иметь только один защитный боевой перк.',
        'one_attack' => 'Необходимо выбрать атакующий перк.',
        'one_defence' => 'Необходимо выбрать защитный перк.'
    ],
    'fates' => [
        'invalid' => 'Ошибка выбора судеб',
        'one_dual' => 'Вы можете иметь только одну двойственную судьбу.'
    ],
    'vox' => [
        'not_enough' => 'Недостаточно очков Голоса.'
    ],
    'spheres' => [
        'not_belongs' => 'Ошибка выбора сферы.',
        'not_enough' => 'Недостаточно очков сферы.',
        'invalid' => 'Недействительная сфера.',
        'experience_max' => 'Превышение максимального уровня опытности.'
    ]
];
