...
return [
    ...
    'stat' => [
        'pool' => 'Превышена допустимая сумма характеристик.',
        'update' => 'При перераспределении характеристик нельзя изменять другие характеристики.',
    ],
    'craftpool' => [
    ...
    'perk_pool' => [
        ...
        'too_much' => 'Взято слишком много перков.',
        'no_points' => 'Недостаточно очков перков.',
    ],
    'fates' => [
    ...
    'estitence' => [
        'not_enough' => 'Недостаточно Эститенции.',
    ],
    'spheres' => [
    ...
    'skill_pool' => [
        'invalid' => 'Ошибка выбора навыков.',
        'no_points' => 'Недостаточно очков навыков.'
    ],
    'talent_pool' => [
        'invalid' => 'Непредвиденная ошибка взятия талантов. Выберите новые или обратитесь к администрации.',
        'too_much' => 'Взято слишком много талантов.',
        'no_points' => 'Недостаточно очков талантов.',
    ],
    'attributes' => [
        'address' => 'Адрес',
        'age' => 'Возраст',
