<a href="{{ route('characters.show', $character->login)}}"
   class="bg-white rounded-3xl shadow-lg max-w-sm w-full overflow-hidden pb-4 transition duration-150 ease-in-out transform hover:-translate-y-2 hover:scale-105">
    <div class="relative">
