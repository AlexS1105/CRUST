  ...
  <x-container class="max-w-3xl mx-auto">
    ...
    <form class="space-y-8" method="POST" action="{{ route('characters.store') }}" enctype="multipart/form-data">
      ...
      <x-form.card>
        ...
        <x-form.textarea name="description" maxlength="512" required onfocus="preview(this)" placeholder="{{ __('characters.placeholder.description') }}" wrap="on" />
      ...
      <x-form.card>
        ...
        <x-form.textarea name="appearance" maxlength="10000" required onfocus="preview(this)" placeholder="{{ __('characters.placeholder.appearance') }}" wrap="on" />
      </x-form.card>
      ...
      <x-form.card>
        ...
        <x-form.textarea name="background" onfocus="preview(this)" placeholder="{{ __('characters.placeholder.background') }}" wrap="on" />
      ...
      <x-form.card>
        ...
        <x-form.textarea name="player_only_info" onfocus="preview(this)" placeholder="{{ __('characters.placeholder.player_only_info') }}" wrap="on" />
      </x-form.card>
