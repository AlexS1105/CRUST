...
return [
    ...
    'craftpool' => [
        'maxtiers' => 'Персонаж может иметь только одно ремесло 3-го тира.',
        ...
        'narrative_crafts' => 'Недостаточно очков для взятия нарративых ремесел.'
    ],
    ...
    'perkpool' => [
        ...
        'unique' => 'Вы не можете брать уникальные перки при создании персонажа.',
        'not_enough_combat' => 'Недостаточно очков боевых перков.',
        'not_enough_noncombat' => 'Недостаточно очков небоевых перков.',
    ...
    'fates' => [
        ...
        'dual_only' => 'Вы можете иметь только одну двойственную судьбу, без каких-либо иных.',
        'one_dual' => 'Вы можете иметь только одну двойственную судьбу.',
        'one_ambition' => 'Вы можете иметь только одну амбицию.',
        'one_flaw' => 'Вы можете иметь только один порок.'
    ],
    'vox' => [
