...
return [
    ...
    'character' => [
        ...
        'narrative_crafts' => 'За каждые 2 очка в Технике, Магии или Изобретательности персонаж получает бесплатное умение. Их также можно покупать за нераспределенные очки общих ремёсел. Не рекомендуется брать более 5 умений, даже если доступно больше.',
