...
return [
    ...
    'character' => [
        ...
        'background' => 'Предыстория персонажа, кем он был, как стал тем, кто он есть. Хватит 1-2 абзацев, не гонитесь за размером, квенты всё равно никто, кроме регистраоров, не читает. Характер и всё такое - сюда же.',
        ...
        'login' => 'Техническое имя персонажа, которое будет использоваться в командах. Должно соответствовать имени персонажа. ВНИМАНИЕ: После создания персонажа изменить логин уже нельзя!',
        ...
        'perks' => 'Если перк предполагает какой-то выбор, то укажите его в примечании. Если цена может варьироваться - добавьте ее в поле доп. цены.',
