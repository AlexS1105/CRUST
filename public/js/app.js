...
__webpack_require__(/*! ./marked */ "./resources/js/marked.js");
...
__webpack_require__(/*! ./fates */ "./resources/js/fates.js");
...
function addNarrativeCraftCard(name, description) {
  ...
  deleteButton.onclick = function () {
    narrativeCrafts = narrativeCrafts.filter(function (_card) {
...
function addFateCard(fate) {
  ...
  deleteButton.onclick = function () {
    fates = fates.filter(function (_card) {
      return _card.id != card.id;
    });
    card.remove();
    updateMaxFates();
...
document.querySelectorAll('div.markdown').forEach(function (div) {
  div.innerHTML = (0,marked__WEBPACK_IMPORTED_MODULE_1__["default"])(dompurify__WEBPACK_IMPORTED_MODULE_0___default().sanitize(div.innerHTML));
});
...
window.updatePermissions = function (initial) {
  permissions.forEach(function (permission) {
    if (!initial || !userPermissions.includes(permission)) {
      var permissionCheckbox = document.getElementsByName("permissions[".concat(permission, "]"))[0];
...
window.updateRole = function (roleId, checked) {
  if (checked != userRoles.includes(roleId)) {
    if (checked) {
      ...
      userRoles = userRoles.filter(function (e) {
        return e !== roleId;
      });
    }
  }
...
window.hasPermission = function (permission) {
  ...
  userRoles.forEach(function (roleId) {
    ...
    if (role.permissions.find(function (e) {
